...
<div class="bg-video">
	<div class="video">
		<video autoplay="true" muted="true" loop="true" class="full-height">
			<source src="<?php echo get_template_directory_uri(); ?>/assets/video/flowetik-cloud-web.mp4" type="video/mp4" />
			<source src="<?php echo get_template_directory_uri(); ?>/assets/flowetik-cloud-web.ogv" type="video/ogg" />
		</video>
	</div>
</div>
